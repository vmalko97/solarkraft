...
class PostsListener
{
    ...
    {
        return in_array(get_post_type(), ['page', 'post']) &&
            preg_match('/<!--\s?{/', get_post_field('post_content'))
            ? false
            : $result;
    }

    public static function postStates($post_states, \WP_Post $post = null)
    {
        // is builder?
    ...
    public static function postActions($actions, \WP_Post $post)
    {
