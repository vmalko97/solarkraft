...
// Overlay
$overlay = $props['image'] && ($props['media_overlay'] || $props['media_overlay_gradient']) ? $this->el('div', [
...
// Tile
$tile = $props['style'] || $props['image'] ? $this->el('div', [
...
// Extra `div` needed because of grid padding. Tile already has stacking context.
$container = $props['vertical_align'] || $overlay || !empty($props['element_absolute']) ? $this->el('div', [
...
// Sticky
$sticky = $props['position_sticky'] ? $this->el('div', [

    'class' => [
        'uk-panel uk-position-z-index',
    ],
