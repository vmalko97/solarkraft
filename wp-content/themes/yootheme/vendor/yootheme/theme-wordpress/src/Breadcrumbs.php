    ...
    protected static function handleDate()
    {
        ...
        switch (true) {
            case is_day():
                $items[] = [
                    'name' => get_the_time(
                        _x('d', 'day archive breadcrumb date format', 'yootheme'),
                        $post
                    ),
            ...
            case is_month():
                $items[] = [
                    'name' => get_the_time(
                        _x('F', 'monthly archive breadcrumb date format', 'yootheme'),
                        $post
                    ),
            ...
            default:
                $items[] = [
                    'name' => get_the_time(
                        _x('Y', 'yearly archive breadcrumb date format', 'yootheme'),
                        $post
                    ),
