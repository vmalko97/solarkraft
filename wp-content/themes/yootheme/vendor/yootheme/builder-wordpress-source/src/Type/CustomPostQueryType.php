                ...
                "custom{$base}" => [
                    ...
                    'metadata' => [
                        ...
                        'fields' => array_merge($terms ? ['terms' => $terms] + $operators : [], [
                            ...
                            'users_operator' => [
                                'description' => trans(
                                    'Filter %post_types% by authors. Use the <kbd>shift</kbd> or <kbd>ctrl/cmd</kbd> key to select multiple users. Set the logical operator to match or not match the selected authors.',
                                    ['%post_types%' => $plural]
                                ),
                                'type' => 'select',
                                'default' => 'IN',
