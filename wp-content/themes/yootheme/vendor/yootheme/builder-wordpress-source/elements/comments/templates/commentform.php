...
if (have_comments()) {
    ...
    $title = $view->el('h3', [
        ...
        'class' => [
            'el-title',
            'uk-h4 uk-margin-medium-top comment-reply-title',
        ],
...
comment_form([
    ...
    'title_reply_before' => $title($props),

    'title_reply_after' => $title->end(),

    'cancel_reply_before' => ' <small>',

    'cancel_reply_after' => '</small>',

    'comment_field' => '<p class="comment-form-comment"><label class="uk-form-label" for="comment">' . _x('Comment', 'noun', 'yootheme') . '</label><textarea class="uk-textarea" id="comment" name="comment" rows="8" required aria-required="true">' . '</textarea></p>',
