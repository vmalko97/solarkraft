...
<div id="comments" class="uk-margin-large-top">
    ...
    <?php if (have_comments()) : ?>
        ...
        <h2 class="uk-h3 uk-heading-bullet uk-margin-medium-bottom"><?php printf(_n(__('Comment'), __('Comments (%s)', 'yootheme'), get_comments_number()), number_format_i18n(get_comments_number())) ?></h2>
