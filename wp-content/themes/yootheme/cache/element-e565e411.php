<?php // $file = /var/www/vhosts/brave-lalande.185-133-207-10.plesk.page/httpdocs/wp-content/themes/yootheme/vendor/yootheme/builder/elements/column/element.json
...
return [
  ...
  'fields' => [
    ...
    'position_sticky' => [
      ...
      'description' => 'Stick the column to the top of the viewport while scrolling down. The column will stop being sticky when it reaches the bottom of its containing row.', 
      'type' => 'checkbox', 
      'text' => 'Stick to viewport'
    ], 
    'position_sticky_offset' => [
      'label' => 'Position Sticky Offset', 
      'description' => 'Set the offset from the top of the viewport where the column should become sticky.', 
      'attrs' => [
        'placeholder' => '0'
      ], 
    ...
    'position_sticky_breakpoint' => [
      ...
      'description' => 'Make the column sticky only from this device width and larger.', 
      'type' => 'select', 
      'options' => [
        'Always' => '', 
