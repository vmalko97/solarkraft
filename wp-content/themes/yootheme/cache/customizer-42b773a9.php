<?php // $file = /var/www/vhosts/brave-lalande.185-133-207-10.plesk.page/httpdocs/wp-content/themes/yootheme/vendor/yootheme/theme/config/customizer.json
  ...
  'panels' => [
    ...
    'navbar-items' => [
      ...
      'fields' => [
        'items' => [
          'type' => 'menu-items', 
          'position' => ['navbar', 'header', 'toolbar-left', 'toolbar-right'], 
          'fields' => [
            'image' => [
              'label' => 'Image', 
