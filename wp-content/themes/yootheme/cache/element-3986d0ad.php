<?php // $file = /var/www/vhosts/brave-lalande.185-133-207-10.plesk.page/httpdocs/wp-content/themes/yootheme/vendor/yootheme/builder/elements/section/element.json
...
return [
  ...
  'fields' => [
    ...
    'height' => [
      'label' => 'Height', 
      'description' => 'Enabling viewport height on a section that directly follows the header will subtract the header height from it. On short pages, a section can be expanded to fill the viewport.', 
      'type' => 'select', 
      'options' => [
        'None' => '', 
        'Viewport' => 'full', 
