<?php // $file = /var/www/vhosts/brave-lalande.185-133-207-10.plesk.page/httpdocs/wp-content/themes/yootheme/vendor/yootheme/builder-wordpress-source/elements/pagination/element.json
...
return [
  ...
  'fields' => [
    ...
    'pagination_taxonomy' => [
      ...
      'type' => 'select', 
      'options' => $config->get('customizer.allTaxonomies'), 
      'enable' => 'pagination_type == \'previous/next\''
    ], 
