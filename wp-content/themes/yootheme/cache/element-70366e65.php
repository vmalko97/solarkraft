<?php // $file = /var/www/vhosts/brave-lalande.185-133-207-10.plesk.page/httpdocs/wp-content/themes/yootheme/vendor/yootheme/builder/elements/switcher/element.json
...
return [
  ...
  'fields' => [
    ...
    'nav_style_primary' => [
      ...
      'enable' => '(nav_position == \'left\' || nav_position == \'right\') && $match(nav, \'(^subnav)\')'
    ], 
    'nav_align' => [
      'label' => 'Alignment', 
      ...
      'enable' => 'nav_position == \'top\' || nav_position == \'bottom\''
    ], 
    'nav_margin' => [
      'label' => 'Margin', 
    ...
    'nav_grid_width' => [
      ...
      'enable' => 'nav_position == \'left\' || nav_position == \'right\''
    ], 
    'nav_grid_column_gap' => [
    ...
    'default' => [
      ...
      'fields' => [[
          ...
          'fields' => [[
              ...
              'type' => 'group', 
              'divider' => true, 
              'fields' => ['switcher_animation', 'switcher_height']
            ], [
              'label' => 'Navigation', 
              'type' => 'group', 
              'divider' => true, 
