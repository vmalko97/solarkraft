<?php // $file = /var/www/vhosts/brave-lalande.185-133-207-10.plesk.page/httpdocs/wp-content/themes/yootheme/vendor/yootheme/builder/elements/panel-slider/element.json
...
return [
  ...
  'fields' => [
    ...
    'image_grid_column_gap' => [
      ...
      'enable' => 'show_image && (image_align == \'left\' || image_align == \'right\') && !(panel_image_no_padding && panel_style)'
    ], 
    'image_grid_row_gap' => [
      'label' => 'Grid Row Gap', 
      'description' => 'Set the size of the gap if the grid items stack.', 
