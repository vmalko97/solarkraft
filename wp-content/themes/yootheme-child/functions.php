...
add_action('wp_enqueue_scripts', function (){
    ...
    wp_enqueue_script('google_maps', get_stylesheet_directory_uri().'/assets/js/map.js', ['jquery-3','html2canvas']);
    ...
    wp_enqueue_script( 'main', get_stylesheet_directory_uri().'/assets/js/main.js', [], false, true );
